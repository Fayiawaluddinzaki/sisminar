...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>/sertif/style.css">
    <script src="<?= base_url(); ?>/sertif/app.js"></script>
...
<body>
        ...
        <div class="container">
            ...
            <div class="sertifikat" id="capture">
                <div class="logoContainer">
                    <img crossorigin="anonymous" src="<?= base_url(); ?>/sertif/img/logoupn.png">
                ...
                <div class="contentSertifikat">
                    <span class="titleName"><?= user()->firstname; ?> <?= user()->lastname; ?></span><br>
                    ...
                    <div class="ttdContent" v-for="(penyelenggara, index) in mengetahui">
                        <b>
                            ...
                            <span class="subtitleName">{{penyelenggara.nama}}
                                <hr>{{penyelenggara.nomorIdentitas}}</span>
                        </b>
                    </div>
                </div>

                <img class="bgImage" src="https://raw.githubusercontent.com/rdfariz/sertifikat-input/master/img/BG.jpg"
                    alt="">
    ...
    <script>
        new Vue({
            ...
            created() {
                this.addPenyelenggara("Ketua Pelaksana", "Fayi Awaluddin Zaki", "NPM 18081010133")
            },
            methods: {
                ...
                download(format) {
                    if (this.namaPeserta == '') {
                        ...
                        if (format == "pdf") {
                            ...
                            $("html").addClass(
                                "hide-scrollbar"); //hide scrollbar because it is showing left white padding
                            html2canvas(document.querySelector("#capture"), {
                                ...
                                document.querySelector("#elementH").appendChild(canvas).setAttribute(
                                    'class', 'no-print');
                                this.message =
                                    "Jika popup tidak muncul scroll kebawah lalu klik kanan save image as"
                            });
